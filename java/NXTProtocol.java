...
public class NXTProtocol extends Thread {
    ...
    public NXTProtocol(String pPath) {
        ...
        new FWriter(pPath + "/send.txt", false);
    ...
    public static void main(String[] args) {
         ...
         * tempConn.connect(); try { Thread.sleep(1000); } catch
         * (InterruptedException e) { // TODO Auto-generated catch block
         * e.printStackTrace(); } for (byte b : np.stringToByteArray("i")) {
         * tempConn.send(b); } tempConn.send((byte) 1); tempConn.send((byte) 1);
         * 
         * try { Thread.sleep(10000); } catch (InterruptedException e) { // TODO
         * Auto-generated catch block e.printStackTrace(); }
         * 
         * for (byte b : np.stringToByteArray("r")) { tempConn.send(b); }
         * tempConn.send((byte) 1); tempConn.send((byte) 1);
         */
    }
}
